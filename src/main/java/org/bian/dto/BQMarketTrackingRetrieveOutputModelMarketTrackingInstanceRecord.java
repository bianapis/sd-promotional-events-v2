...
import org.bian.dto.BQMarketTrackingRetrieveOutputModelMarketTrackingInstanceRecordMarketTrackingWorkTask;

import javax.validation.Valid;
  
/**
 * BQMarketTrackingRetrieveOutputModelMarketTrackingInstanceRecord
 */
public class BQMarketTrackingRetrieveOutputModelMarketTrackingInstanceRecord   {
  private String marketTrackingWorkTaskType = null;

  private BQMarketTrackingRetrieveOutputModelMarketTrackingInstanceRecordMarketTrackingWorkTask marketTrackingWorkTask = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The type of work task (e.g. track promotional event activity, assess participation impact) 
  ...
  **/
  ...
  public BQMarketTrackingRetrieveOutputModelMarketTrackingInstanceRecordMarketTrackingWorkTask getMarketTrackingWorkTask() {
    return marketTrackingWorkTask;
  }

  public void setMarketTrackingWorkTask(BQMarketTrackingRetrieveOutputModelMarketTrackingInstanceRecordMarketTrackingWorkTask marketTrackingWorkTask) {
